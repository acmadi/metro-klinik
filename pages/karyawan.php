...
var str = '<div id=form_add>'+
            ...
            '<table width=100% class=data-input>'+
                ...
                '<tr><td>Jabatan:</td><td><select name=jabatan id=jabatan><option value="Staff">Staff</option><option value="Dokter">Dokter</option><option value="APA">APA</option><option value="Kasir">Kasir</option></select></td></tr>'+
